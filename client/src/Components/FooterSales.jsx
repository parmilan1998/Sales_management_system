    ...
    <div>
      <footer className=" bg-primary text-white font-poppins">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto text-md mt-6 max-w-md text-center leading-relaxed text-md font-extralight tracking-wider text-white">
            Transform your sales process with our cutting-edge management
            system. It offers seamless integration, real-time data, and powerful
          ...
          <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
            <li>
              <Link
                to="/products"
                className="text-white text-md font-extralight tracking-wide transition hover:text-white/75"
              >
                Products
              </Link>
            </li>
